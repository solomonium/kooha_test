...
import 'package:kooha_test/utils/extensions/time.dart';
...
// class TextStyles {
//   static TextStyle nunito = Satoshi();

//   static TextStyle get t1 => nunito.regular.size(FontSizes.s16);

//   static TextStyle get t2 => nunito.semiBold.size(FontSizes.s14);

//   static TextStyle get h1 => nunito.bold.size(FontSizes.s96);

//   static TextStyle get h2 => nunito.bold.size(FontSizes.s60);

//   static TextStyle get h3 => nunito.bold.size(FontSizes.s48);

//   static TextStyle get h4 => nunito.bold.size(FontSizes.s28);

//   static TextStyle get h5 => nunito.bold.size(FontSizes.s24);

//   static TextStyle get h6 => nunito.semiBold.size(FontSizes.s20);

//   static TextStyle get h7 => nunito.semiBold.size(FontSizes.s18);

//   static TextStyle get body1 => nunito.regular.size(FontSizes.s16);

//   static TextStyle get body2 => nunito.regular.size(FontSizes.s14);

//   static TextStyle get body3 => nunito.size(FontSizes.s12);

//   static TextStyle get footnote => nunito.regular.size(FontSizes.s10);

//   static TextStyle get caption => nunito.regular.size(FontSizes.s12);

//   static TextStyle get button => nunito.light.size(
//         FontSizes.s18,
//       );
// }
